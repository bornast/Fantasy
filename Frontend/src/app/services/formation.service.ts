...
export class FormationService {
    ...
    getFormationsByFilter(name?: string, pageNumber: any = 0, pageSize: any = 10): Observable<PaginatedResult<RecordName[]>> {
    ...
    createFormation(objectToCreate) {
		return this.http.post(this.baseUrl, objectToCreate);
	}

    updateFormation(id, objectToUpdate) {
